...
var gameDialogPlaying := false setget _setGameDialogPlaying, _getGameDialogPlaying
...
func _setGameDialogPlaying(value):
	gameDialogPlaying = value

func _getGameDialogPlaying():
	return gameDialogPlaying
